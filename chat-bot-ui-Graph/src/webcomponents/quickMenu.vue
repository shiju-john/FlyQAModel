<template>
	<div class="quick-menu" ref="quickMenu" :style="quickMenuStyle" style="cursor: pointer; " title="menu">
    <div v-for="n in menuCount" class="sub-menu" :style="getSubMenu(n-1)">
        <a :title="menuUrlList[n-1].name" :style="subMenuStyle" @mouseover.stop="mouseEnterSubMenu" @mouseout.stop="mouseOutSubMenu" @click="processCallback(menuUrlList[n-1])">
          <i :class="menuUrlList[n-1].icon" ref="icon" ></i>
        </a>
      </div>
